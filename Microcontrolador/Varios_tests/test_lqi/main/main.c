...
//const float K_new[2] = {48.1955, -27.9267}; // Pole placement {-0.2+0.5*j; -0.2-0.5*j; 0.5}, pole obs {0.1, -0.1}
//const float ki = -1.9110;                   // Pole placement

//const float K_new[2] = {-3.1589, 4.4732};   // LQI funcional en rangos de 4 V en adelante, con u_signal hasta 40095
//const float ki = -440.6668;                 // LQI


const float K_new[2] = {-2.4754, 3.3728};   // LQI muy hermoso, pero complicado en bajos rangos
const float ki = -45.7992;                 // LQI


//float l11 = 1.8440; // Pole placement {0.1; -0.1}
//float l21 = 2.5443;
...
void timer_callback(void* arg){
    ...
    pwm_output_bits = (int) (u_signal) * 4095 / 40095;
